<section id="banner">
    <div class="container-fluid pt-3 pt-lg-0">
        <div class="banner-container border-radius overflow-hidden position-relative">
            <img src="assets/img/banner-bg.jpg" class="banner-bg img-fluid w-100 h-100" alt="Banner Background Image">
            <div class="banner-inner-container">
                <h1><?php echo tr("BANNER_TITLE"); ?></h1>
                <div class="banner-buttons">
                    <a href="#services" class="btn btn-primary btn-banner"><?php echo tr("OUR_SERVICES"); ?></a>
                    <a href="#contact" class="btn btn-outline-light btn-banner"><?php echo tr("CONTACT_US"); ?></a>
                </div>
            </div>
        </div>
    </div>
